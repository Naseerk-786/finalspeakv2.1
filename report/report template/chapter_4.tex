...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig_04_training_curves.png}
...
Rather than manually scraping more generic images, we built an interactive desktop application (\texttt{prototype/sign\_recorder\_studio.py}) to capture our own personal sign geometry:
\begin{itemize}
