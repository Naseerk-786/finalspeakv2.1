...
We engineered a **Bidirectional Conversational Loop** (illustrated in Figure~\ref{fig:twoway_loop}):
...
As shown in Figure~\ref{fig:latency_breakdown}, total end-to-end system latency from camera acquisition to speech playback is **$23.4\text{ ms}$**, well below the 50ms human perception ceiling.
